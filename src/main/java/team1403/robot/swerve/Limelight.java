...
//     // return Units.degreesToRadians(result.hasTargets() ?
//     // fieldLayout.getTagPose((result.getBestTarget().getFiducialId())).get().getRotation().getZ()
//     // : 0);
...
//         return null;
//       }
//       return PhotonUtils.estimateFieldToRobotAprilTag(result.getBestTarget().getBestCameraToTarget(), pose.get(),
...
//     if (!hasTarget())
//       return null;
//     return new Matrix<N3, N1>(VecBuilder.fill(getXDistance() * getAmbiguity(), getYDistance() * getAmbiguity(),
//         result.getBestTarget().getBestCameraToTarget().getRotation().getAngle() * getAmbiguity()));
//   }
